...
public class TankConstructor {
    public static ITank createDrumTank(double internalCooldown, double externalCooldown, int capacity,
                                       double hp, double speedF, double speedB, boolean isSAU, double missileSpeed, double damage) {
        ITurret turret = (isSAU) ? new SAUTurret() : new TankTurret(10);
        IChassis chassis = new Chassis(speedF, speedB, 10);
        return new DrumTank(turret, chassis, (int) internalCooldown, (int) externalCooldown, capacity, (int) hp, missileSpeed, damage);
    }
    ...
    public static ITank createCyclicalTank(double coolDown,
        ...
        return new CyclicalTank(turret, chassis, (int) coolDown, (int) hp, missileSpeed, damage);
    }
}
